...
import random
import imdb
datasets = {'imdb': (imdb.prepare_data)}
...
def train_lstm(
    ...
    print('Loading data')
    train, valid, test = ((trainD, trainO),(validD,validO),(testD, testO))
    if test_size > 0:
